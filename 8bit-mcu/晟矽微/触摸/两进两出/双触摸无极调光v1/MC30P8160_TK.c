...
//;****************************************************************************
//; 触摸程序
//; 初始化触摸参数:  	   	   	   	void SET_TOUCH_OPTION();+ void SET_TOUCH_OPTION2();;
//; 休眠唤醒后重新设定触摸参数:		void SET_TOUCH_OPTION2();
//; 调用入口: 	   	   	   	   	   	void SCAN_TOUCH();
//;--------------------------
//; 出口：TOUCH_FLAG (BIT0对应TK0-P10，类推BIT3对应TK3-P13),对应BIT位为1表示有触摸，为0表示没有触摸
//;****************************************************************************
//;****************************************************************************

#include "MC30P8160_include.h"
#include "MC30P8160_TK.h" 
#include "MC30P8160_TKSRAM.h" 
