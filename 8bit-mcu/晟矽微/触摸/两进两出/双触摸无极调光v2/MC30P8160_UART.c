...
//;****************************************************************************
//; 串口程序
//; 波特率初始化:	void SET_UART_9600BPS();	//;设定波特率
//; 中断调用：		void UART_SUB();
//; 数据刷新：		void SCAN_UART_OUT();
//; 重新/再次启动：	void OPEN_OUT_UART();
//;****************************************************************************
//;****************************************************************************

#include "MC30P8160_include.h"
#include "MC30P8160_UART.h" 
...
//;	MOVAI   10001100B			//;定时器2配置,BIT7=T2EN,BIT4-3:时钟源选定,BIT0-2:定时器分频
//;	MOVRA   T2CR
