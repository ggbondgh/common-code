...
#define  PRS_64  6
#define  PRS_128 7
#define Key_Sign       flag1.bits.bit0
#define Y_OFF_Flag     flag2.bits.bit0
...
void IO_Init(void)
{
	// xxx0：bit5~0分别对应P05~P00        xxx1：bit7~0分别对应P17~P10
	
    IOP0 = 0x00;                       //io口数据位
    OEP0 = 0xFF;                       //io口方向 1:out    0:in
    PUP0 = 0x00;                       //io口上拉电阻      1:enable 0:disable
    PDP0 = 0x00;                       //io口下拉电阻      1:enable 0:disable
    ADIOS0 = 0x00;                     //io类型选择     1:模拟输入     0:通用io    bit7-bit0 P12、P11、P10、P05、P04、P03、P02、P00
    ...
    ADIOS1 = 0x00;                     //io类型选择  1:模拟输入  0:通用io bit1-bit0 P15、P14

    PMOD = 0x00;                       //bit7-bit5 P17、P13、P01 io类型选择           1:模拟输入     0:通用io
